    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button className="flex items-center gap-2 px-3 py-2 text-sm rounded-md border hover:bg-gray-50">
      ...
      <div className="bg-white rounded-lg shadow-card p-4 flex flex-wrap items-center gap-3">
        ...
        <div className="relative flex-1 min-w-[260px]">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-md border focus:outline-none focus:ring-2 focus:ring-orange-300"
          />
        </div>
        ...
        <div className="relative">
          <select
            className="appearance-none pl-3 pr-8 py-2 rounded-md border text-sm focus:outline-none focus:ring-2 focus:ring-orange-300"
            value={role}
            onChange={(e) => {
